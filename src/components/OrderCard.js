  ...
  return (
    <div className='flex flex-col items-start w-full gap-3 mt-[70px] mb-11'>
        ...
        <div className='w-full flex items-center justify-between'>
            ...
            <span className='text-[#CCCCCC] font-semibold text-base'>{`+$${count==0?0:10.00}`}</span>
        </div>
        <div className='w-full flex items-end justify-between'>
            <span className='text-white font-semibold text-xl'>Total</span>
            <span className='text-white font-semibold text-xl'>{`$${count==0?0:(count*199.00)+10.00}`}</span>
        </div>
